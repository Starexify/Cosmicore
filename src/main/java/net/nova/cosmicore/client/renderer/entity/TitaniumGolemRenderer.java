...
public class TitaniumGolemRenderer extends MobRenderer<TitaniumGolem, TitaniumGolemRenderState, TitaniumGolemModel> {
  private static final Identifier GOLEM_LOCATION = Cosmicore.rl("textures/entity/titanium_golem/titanium_golem.png");
  ...
  public Identifier getTextureLocation(TitaniumGolemRenderState titaniumGolemRenderState) {
