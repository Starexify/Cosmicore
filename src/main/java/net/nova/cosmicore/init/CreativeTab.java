...
public class CreativeTab {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> COSMICORE_TAB = CREATIVE_TAB.register("cosmicore_tab", () -> CreativeModeTab.builder()
            .icon(() -> new ItemStack(CBlocks.RAW_TITANIUM_BLOCK))
