...
public interface CArmorMaterials {
  ArmorMaterial TITANIUM = new ArmorMaterial(
      29, makeDefense(3, 6, 8, 3, 7), 17, SoundEvents.ARMOR_EQUIP_IRON, 2.5F, 0.09F, Tags.CItemTags.REPAIRS_TITANIUM_ARMOR, CEquipmentAssets.TITANIUM
  );
  ArmorMaterial LONSDALEITE = new ArmorMaterial(
      29, makeDefense(3, 6, 8, 3, 13), 18, SoundEvents.ARMOR_EQUIP_DIAMOND, 3.5F, 0.15F, Tags.CItemTags.REPAIRS_LONSDALEITE_ARMOR, CEquipmentAssets.LONSDALEITE
  );
