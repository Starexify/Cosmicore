...
public class CItems {
    ...
    public static final DeferredItem<Item> TITANIUM_SWORD = ITEMS.register("titanium_sword", () -> new SwordItem(CToolTiers.TITANIUM, new Item.Properties().attributes(SwordItem.createAttributes(CToolTiers.TITANIUM, 3, -2.4F))));
    public static final DeferredItem<Item> TITANIUM_PICKAXE = ITEMS.register("titanium_pickaxe", () -> new PickaxeItem(CToolTiers.TITANIUM, new Item.Properties().attributes(PickaxeItem.createAttributes(CToolTiers.TITANIUM, 1.0F, -2.8F))));
    public static final DeferredItem<Item> TITANIUM_AXE = ITEMS.register("titanium_axe", () -> new AxeItem(CToolTiers.TITANIUM, new Item.Properties().attributes(AxeItem.createAttributes(CToolTiers.TITANIUM, 5.0F, -3.0F))));
    public static final DeferredItem<Item> TITANIUM_SHOVEL = ITEMS.register("titanium_shovel", () -> new ShovelItem(CToolTiers.TITANIUM, new Item.Properties().attributes(ShovelItem.createAttributes(CToolTiers.TITANIUM, 1.5F, -3.0F))));
    public static final DeferredItem<Item> TITANIUM_HOE = ITEMS.register("titanium_hoe", () -> new HoeItem(CToolTiers.TITANIUM, new Item.Properties().attributes(HoeItem.createAttributes(CToolTiers.TITANIUM, -3.5F, 0.0F))));
