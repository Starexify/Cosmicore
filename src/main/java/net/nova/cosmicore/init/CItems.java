...
public class CItems {
  ...
  // Banner Pattern
  public static final DeferredItem<Item> METEORITE_BANNER_PATTERN = ITEMS.registerItem("meteorite_banner_pattern",
      properties -> new Item(properties
          .stacksTo(1)
          .rarity(Rarity.RARE)
          .delayedComponent(DataComponents.PROVIDES_BANNER_PATTERNS, context -> context.getOrThrow(CTags.BannerPatternTags.PATTERN_ITEM_METEORITE)))
  );

  // Spawn Eggs
//    public static final DeferredItem<SpawnEggItem> TITANIUM_GOLEM_SPAWN_EGG = ITEMS.registerItem("titanium_golem_spawn_egg", properties -> new SpawnEggItem(properties));
}