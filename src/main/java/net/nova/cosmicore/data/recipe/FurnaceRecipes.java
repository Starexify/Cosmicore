...
public class FurnaceRecipes extends CRecipeProvider {
  ...
  public void build() {
    // Titanium Stuff
    oreSmelting(TITANIUM_SMELTABLES, RecipeCategory.MISC, CookingBookCategory.MISC, CItems.TITANIUM_INGOT, 0.7F, 200, "titanium_ingot");
    oreBlasting(TITANIUM_SMELTABLES, RecipeCategory.MISC, CookingBookCategory.MISC, CItems.TITANIUM_INGOT, 0.7F, 100, "titanium_ingot");
