...
public class CItemModelGenerator extends ItemModelGenerators {
    public static final List<CItemModelGenerator.TrimMaterialData> TRIM_MATERIAL_MODELS = List.of(
            new CItemModelGenerator.TrimMaterialData("quartz", TrimMaterials.QUARTZ, Map.of()),
            new CItemModelGenerator.TrimMaterialData("iron", TrimMaterials.IRON, Map.of(EquipmentAssets.IRON, "iron_darker")),
            new CItemModelGenerator.TrimMaterialData("netherite", TrimMaterials.NETHERITE, Map.of(EquipmentAssets.NETHERITE, "netherite_darker")),
            new CItemModelGenerator.TrimMaterialData("redstone", TrimMaterials.REDSTONE, Map.of()),
            new CItemModelGenerator.TrimMaterialData("copper", TrimMaterials.COPPER, Map.of()),
            new CItemModelGenerator.TrimMaterialData("gold", TrimMaterials.GOLD, Map.of(EquipmentAssets.GOLD, "gold_darker")),
            new CItemModelGenerator.TrimMaterialData("emerald", TrimMaterials.EMERALD, Map.of()),
            new CItemModelGenerator.TrimMaterialData("diamond", TrimMaterials.DIAMOND, Map.of(EquipmentAssets.DIAMOND, "diamond_darker")),
            new CItemModelGenerator.TrimMaterialData("lapis", TrimMaterials.LAPIS, Map.of()),
            new CItemModelGenerator.TrimMaterialData("amethyst", TrimMaterials.AMETHYST, Map.of()),
            new CItemModelGenerator.TrimMaterialData("resin", TrimMaterials.RESIN, Map.of()),
            new CItemModelGenerator.TrimMaterialData("livingmetal", CTrimMaterials.TITANIUM, Map.of(CEquipmentAssets.TITANIUM, "titanium_darker")),
            new CItemModelGenerator.TrimMaterialData("lonsdaleite", CTrimMaterials.LONSDALEITE, Map.of(CEquipmentAssets.LONSDALEITE, "lonsdaleite_darker"))
    );
    ...
    public void generateTrimmableItem(Item item, ResourceKey<EquipmentAsset> equipmentAsset) {
        ...
        for (CItemModelGenerator.TrimMaterialData trimMaterial : TRIM_MATERIAL_MODELS) {
