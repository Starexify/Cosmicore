...
public class CTextureMappings {
  ...
  public static TextureMapping templateCrusher(Block block) {
    return (new TextureMapping()).put(TextureSlot.LAYER0, TextureMapping.getBlockTexture(block)).put(TextureSlot.PARTICLE, new Material(Cosmicore.rl("crusher_base").withPrefix("block/")));
  }
}
